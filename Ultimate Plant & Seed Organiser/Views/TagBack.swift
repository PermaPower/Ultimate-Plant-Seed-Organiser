...
struct TagBack: View {
    ...
    // Bind the contentOffset to Parent View
    @Binding var contentOffset: CGFloat
    
    @State var textLableSubTitle = "Back"
...
//                                Text("Back Tag Pos: \(String(format: "%.2f",frontTagValue.score))")
//                                    .foregroundColor(Color.white)
...
struct TagBack_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView{
            TagBack(contentOffset: .constant(0), textLableSubTitle: "")
        }
    }
}
